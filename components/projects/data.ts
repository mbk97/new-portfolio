export const projecData = [
  {
    ...
    name: "Heycard (Client)",
    description:
      "Discover Heycard, the game-changing spending management tool that brings automation and efficiency to expense tracking. Designed to streamline your business operations, Heycard empowers you to effortlessly monitor a range of crucial financial activities including subscriptions, payouts, transactions, and comprehensive spending reports. ",
    projectImg: "/assets/img/hey-card.png",
    technologies: [
      { id: 1, img: "/assets/img/next.png", text: "Next JS" },
      { id: 2, img: "/assets/img/tailwind.png", text: "Tailwind CSS" },
      { id: 3, img: "/assets/img/redux.png", text: "Redux" },
      { id: 4, img: "/assets/img/ant-design.png", text: "Ant Design" },
      { id: 5, img: "/assets/img/formik.png", text: "Formik" },
    ],
    websiteLink: "https://heycard.app/",
    aos: "flip-right",
    class: true,
  },
  {
    ...
    aos: "fade-up",
    websiteLink: "https://blog-website-liart.vercel.app/",
  ...
  },
  {
    ...
    name: "BrandOn (Client)",
    description:
      "A Bold Agency of Marketing, Data, Research, and Development Experts, Crafting Brands into Invaluable Assets.",
    projectImg: "/assets/img/brandOn.png",
    technologies: [
      { id: 1, img: "/assets/img/next.png", text: "Next JS" },
      { id: 2, img: "/assets/img/tailwind.png", text: "Tailwind CSS" },
    ],
    aos: "zoom-in-down",
    websiteLink: "https://growwithbrandon.com/",
    class: true,
  },
  ...
  {
    id: 5,
    name: "Gericht Kitchen",
    description:
      "A kitchen website showing different delicacies, cocktails, wine, and beers with their prices.",
    projectImg: "/assets/img/kitchen.jpg",
    technologies: [
      { id: 1, img: "/assets/img/react.png", text: "React JS" },
      { id: 2, img: "/assets/img/styled.png", text: "Styled Components" },
      { id: 3, img: "/assets/img/css.png", text: "CSS" },
    ],
    aos: "flip-right",
    websiteLink: "https://kitchen-mbk97.vercel.app/",
    githubLink: "https://github.com/mbk97/kitchen",
    class: true,
  },
];
